...
?>
    ...
    <div class="property-summary page-container">
      ...
      <div class="row no-gutters">
          ...
          <?php
// Assuming $property['address'] contains the address from the database
$google_maps_url = "https://www.google.com/maps/search/?api=1&query=" . urlencode($property_row['address']);
?>
          <div class="button-container col-6">
            <a href="<?php echo $google_maps_url; ?>" target="_blank">
