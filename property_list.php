...
<body>
  ...
  <?php require "./includes/header.php"; ?>
        ...
        ?>
              ...
              <div class="property-card row">
                  ...
                  <div class="content-container col-md-8">
                     ...
                     <div class="row no-gutters align-items-center" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
    <!-- Rent -->
    ...
    <!-- Location -->
    <a href="https://www.google.com/maps/search/?api=1&query=<?php echo urlencode($pg_address); ?>" 
       target="_blank" 
       style="text-decoration: none; color: teal; font-size: 14px; margin-left: 20px;">
        <i class="fas fa-map-marker-alt"></i> View Location
    </a>

    <!-- View Button -->
    <a href="property_detail.php?property_id=<?php echo $pg_id ;?>" class="btn btn-primary" style="margin-left: 20px;">
        View
    </a>
</div>
